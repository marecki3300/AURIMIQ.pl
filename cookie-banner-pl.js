(function () {
  ...
  function injectBanner() {
    ...
    banner.innerHTML = [
      '<p>Ta strona nie używa śledzących plików cookie.',
      'Przechowujemy wyłącznie dane niezbędne do działania serwisu (sesja, preferencje).',
      'Więcej informacji: <a href="/polityka-prywatnosci.html">Polityka prywatności</a>.</p>',
      '<div class="cb-btns">',
      '<button id="aurimiq-cookie-decline">Tylko niezbędne</button>',
      '<button id="aurimiq-cookie-accept">Rozumiem</button>',
      '</div>',
    ].join('');
